...
function $assert_type<T>(x: any, t: string, f: Typed): asserts x is T {
  ...
  Alias(pos: Meta, entity: Entity, name: Name): $T;
  
      }

      export abstract class Declaration extends Node {
        abstract tag: "ForeignType" | "Relation" | "Do" | "Command" | "Define" | "AbstractType" | "EnumType" | "SingletonType" | "Type" | "Trait" | "ImplementTrait" | "Action" | "When" | "Context" | "Open" | "Local" | "Test" | "Effect" | "Capability" | "Protect" | "Decorated" | "Handler" | "DefaultHandler" | "Alias";
  ...
  export class $$Declaration$_Alias extends Declaration {
    ...
    match<$T>(p: $p_Declaration<$T>): $T {
      return p.Alias(this.pos, this.entity, this.name);
    }
  ...
  Namespaced(pos: Meta, namespace: Namespace, name: Name): $T;
  ...
  Any(pos: Meta): $T;
      ...
      export abstract class TypeApp extends Node {
        abstract tag: "Namespaced" | "Named" | "Static" | "Function" | "Any";
  ...
  aliasDeclaration(x: Ohm.Node): any {
    ...
    aliasDeclaration_alt1(this: Ohm.Node, _1: Ohm.Node, e$0: Ohm.Node, _3: Ohm.Node, n$0: Ohm.Node, _5: Ohm.Node): any {
      ; const e = e$0.toAST(); ; const n = n$0.toAST(); 
      return (new (((Declaration).Alias))($meta(this), e, n))
    },
  ...
  typeAppPrimary(x: Ohm.Node): any {
    ...
    typeAppPrimary_alt2(this: Ohm.Node, t$0: Ohm.Node): any {
      const t = t$0.toAST()
  ...
  traitName(x: Ohm.Node): any {
    ...
    traitName_alt1(this: Ohm.Node, n$0: Ohm.Node, _2: Ohm.Node, x$0: Ohm.Node): any {
      ...
      return (new (((Trait).Namespaced))($meta(this), n, x))
    },
    
    traitName_alt2(this: Ohm.Node, x$0: Ohm.Node): any {
      const x = x$0.toAST()
  ...
  newTypeName(x: Ohm.Node): any {
    ...
    newTypeName_alt2(this: Ohm.Node, n$0: Ohm.Node): any {
      const n = n$0.toAST()
