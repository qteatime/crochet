...
function $assert_type<T>(x: any, t: string, f: Typed): asserts x is T {
  ...
  Test(pos: Meta, title: String, body: Statement[]): $T;
      ...
      export abstract class Declaration extends Node {
        abstract tag: "ForeignType" | "Relation" | "Do" | "Command" | "Define" | "AbstractType" | "EnumType" | "SingletonType" | "Type" | "Action" | "When" | "Context" | "Open" | "Local" | "Test";
  ...
  Lit(value: Literal): $T;
      ...
      export abstract class Expression extends Node {
        abstract tag: "New" | "Invoke" | "Global" | "Variable" | "Self" | "List" | "Record" | "Search" | "MatchSearch" | "Project" | "Select" | "For" | "Block" | "Apply" | "Pipe" | "PipeInvoke" | "Interpolate" | "Condition" | "HasType" | "Force" | "Lazy" | "Hole" | "Return" | "Type" | "Lambda" | "IntrinsicEqual" | "ForeignInvoke" | "Parens" | "Lit";
  ...
  primaryExpression(x: Ohm.Node): any {
    ...
    primaryExpression_alt8(this: Ohm.Node, _1: Ohm.Node, t$0: Ohm.Node): any {
      ; const t = t$0.toAST()
      return (new (((Expression).Type))($meta(this), t))
    },
    ...
    primaryExpression_alt11(this: Ohm.Node, n$0: Ohm.Node): any {
      const n = n$0.toAST()
    ...
    primaryExpression_alt13(this: Ohm.Node, _1: Ohm.Node, e$0: Ohm.Node, _3: Ohm.Node): any {
      ; const e = e$0.toAST(); 
