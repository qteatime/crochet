...
function $assert_type<T>(x: any, t: string, f: Typed): asserts x is T {
  ...
  Type(pos: Meta, cmeta: Metadata, typ: TypeDef, fields: Parameter[]): $T;
  ...
  Handler(pos: Meta, cmeta: Metadata, name: Name, parameters: Name[], body: Statement[], handlers: Handler[]): $T;
  
      }

      export abstract class Declaration extends Node {
        abstract tag: "ForeignType" | "Relation" | "Do" | "Command" | "Define" | "AbstractType" | "EnumType" | "SingletonType" | "Type" | "Action" | "When" | "Context" | "Open" | "Local" | "Test" | "Effect" | "Handler";
  ...
  export class $$Declaration$_Type extends Declaration {
    ...
    constructor(readonly pos: Meta, readonly cmeta: Metadata, readonly typ: TypeDef, readonly fields: Parameter[]) {
      super();
      Object.defineProperty(this, "tag", { value: "Type" });
      ($assert_type<Meta>(pos, "Meta", Meta)); ($assert_type<Metadata>(cmeta, "Metadata", Metadata)); ($assert_type<TypeDef>(typ, "TypeDef", TypeDef)); ($assert_type<Parameter[]>(fields, "Parameter[]", $is_array(Parameter)))
    }
  ...
  export class $$Declaration$_Handler extends Declaration {
    ...
    constructor(readonly pos: Meta, readonly cmeta: Metadata, readonly name: Name, readonly parameters: Name[], readonly body: Statement[], readonly handlers: Handler[]) {
      super();
      Object.defineProperty(this, "tag", { value: "Handler" });
      ($assert_type<Meta>(pos, "Meta", Meta)); ($assert_type<Metadata>(cmeta, "Metadata", Metadata)); ($assert_type<Name>(name, "Name", Name)); ($assert_type<Name[]>(parameters, "Name[]", $is_array(Name))); ($assert_type<Statement[]>(body, "Statement[]", $is_array(Statement))); ($assert_type<Handler[]>(handlers, "Handler[]", $is_array(Handler)))
    }

    match<$T>(p: $p_Declaration<$T>): $T {
      return p.Handler(this.pos, this.cmeta, this.name, this.parameters, this.body, this.handlers);
    }
  ...
  Use(pos: Meta, name: Name, args: Expression[]): $T;
  
      }

      export abstract class Handler extends Node {
        abstract tag: "On" | "Use";
        abstract match<$T>(p: $p_Handler<$T>): $T;
  ...
  export class $$Handler$_On extends Handler {
    readonly tag!: "On";
    ...
    match<$T>(p: $p_Handler<$T>): $T {
      return p.On(this.pos, this.name, this.variant, this.args, this.body);
    }

    static has_instance(x: any) {
      return x instanceof $$Handler$_On;
    }
  }
  


  export class $$Handler$_Use extends Handler {
    readonly tag!: "Use";

    constructor(readonly pos: Meta, readonly name: Name, readonly args: Expression[]) {
      super();
      Object.defineProperty(this, "tag", { value: "Use" });
      ($assert_type<Meta>(pos, "Meta", Meta)); ($assert_type<Name>(name, "Name", Name)); ($assert_type<Expression[]>(args, "Expression[]", $is_array(Expression)))
    }

    match<$T>(p: $p_Handler<$T>): $T {
      return p.Use(this.pos, this.name, this.args);
    }

    static has_instance(x: any) {
      return x instanceof $$Handler$_Use;
    }
  }
  ...
  export class Contract extends Node {
    ...
    constructor(readonly pos: Meta, readonly ret: (TypeApp | null), readonly pre: ContractCondition[], readonly post: ContractCondition[]) {
      super();
      Object.defineProperty(this, "tag", { value: "Contract" });
      ($assert_type<Meta>(pos, "Meta", Meta)); ($assert_type<(TypeApp | null)>(ret, "(TypeApp | null)", $is_maybe(TypeApp))); ($assert_type<ContractCondition[]>(pre, "ContractCondition[]", $is_array(ContractCondition))); ($assert_type<ContractCondition[]>(post, "ContractCondition[]", $is_array(ContractCondition)))
    }
  ...
  export class TypeDef extends Node {
    ...
    constructor(readonly parent: (TypeApp | null), readonly name: Name) {
      ...
      ($assert_type<(TypeApp | null)>(parent, "(TypeApp | null)", $is_maybe(TypeApp))); ($assert_type<Name>(name, "Name", Name))
    }
  ...
  Handle(pos: Meta, body: Statement[], handlers: Handler[]): $T;
  ...
  export class $$Expression$_New extends Expression {
    ...
    constructor(readonly pos: Meta, readonly typ: Name, readonly fields: Expression[]) {
      super();
      Object.defineProperty(this, "tag", { value: "New" });
      ($assert_type<Meta>(pos, "Meta", Meta)); ($assert_type<Name>(typ, "Name", Name)); ($assert_type<Expression[]>(fields, "Expression[]", $is_array(Expression)))
    }
  ...
  export class $$Expression$_Handle extends Expression {
    ...
    constructor(readonly pos: Meta, readonly body: Statement[], readonly handlers: Handler[]) {
      super();
      Object.defineProperty(this, "tag", { value: "Handle" });
      ($assert_type<Meta>(pos, "Meta", Meta)); ($assert_type<Statement[]>(body, "Statement[]", $is_array(Statement))); ($assert_type<Handler[]>(handlers, "Handler[]", $is_array(Handler)))
    }
  ...
  FComputed(value: Expression): $T;
  
      }

      export abstract class RecordField extends Node {
        abstract tag: "FName" | "FText" | "FComputed";
  ...
  export class $$RecordField$_FComputed extends RecordField {
    readonly tag!: "FComputed";
  ...
  effectCase(x: Ohm.Node): any {
    ...
    effectCase_alt2(this: Ohm.Node, m$0: Ohm.Node, s$0: Ohm.Node, _3: Ohm.Node): any {
      const m = m$0.toAST(); const s = s$0.toAST(); 
      return (new (EffectCase)($meta(this), m, s, []))
    },
  ...
  handlerDeclaration(x: Ohm.Node): any {
    ...
    handlerDeclaration_alt1(this: Ohm.Node, m$0: Ohm.Node, _2: Ohm.Node, n$0: Ohm.Node, xs$0: Ohm.Node, b$0: Ohm.Node, _6: Ohm.Node, hs$0: Ohm.Node, _8: Ohm.Node): any {
      const m = m$0.toAST(); ; const n = n$0.toAST(); const xs = xs$0.toAST(); const b = b$0.toAST(); ; const hs = hs$0.toAST(); 
      return (new (((Declaration).Handler))($meta(this), m, n, xs, b, hs))
    },
    
  typeParams(x: Ohm.Node): any {
    return x.toAST();
  },
  
    typeParams_alt1(this: Ohm.Node, _1: Ohm.Node, xs$0: Ohm.Node, _3: Ohm.Node): any {
      ; const xs = xs$0.toAST(); 
      return xs
    },
    
  nameParams(x: Ohm.Node): any {
    return x.toAST();
  },
  
    nameParams_alt1(this: Ohm.Node, _1: Ohm.Node, xs$0: Ohm.Node, _3: Ohm.Node): any {
      ; const xs = xs$0.toAST(); 
      return xs
    },
  ...
  handlers(x: Ohm.Node): any {
    ...
    handlers_alt1(this: Ohm.Node, _1: Ohm.Node, n$0: Ohm.Node, _3: Ohm.Node, v$0: Ohm.Node, _5: Ohm.Node, xs$0: Ohm.Node, _7: Ohm.Node, b$0: Ohm.Node): any {
      ; const n = n$0.toAST(); ; const v = v$0.toAST(); ; const xs = xs$0.toAST(); ; const b = b$0.toAST()
      return (new (((Handler).On))($meta(this), n, v, xs, b))
    },
    
    handlers_alt2(this: Ohm.Node, n$0: Ohm.Node, _2: Ohm.Node, xs$0: Ohm.Node, _4: Ohm.Node, _5: Ohm.Node): any {
      const n = n$0.toAST(); ; const xs = xs$0.toAST(); ; 
      return (new (((Handler).Use))($meta(this), n, xs))
    },
  ...
  typeDeclaration(x: Ohm.Node): any {
    ...
    typeDeclaration_alt5(this: Ohm.Node, m$0: Ohm.Node, _2: Ohm.Node, _3: Ohm.Node, t$0: Ohm.Node, fs$0: Ohm.Node, _6: Ohm.Node): any {
      const m = m$0.toAST(); ; ; const t = t$0.toAST(); const fs = fs$0.toAST(); 
  ...
  typeField(x: Ohm.Node): any {
    ...
    typeField_alt1(this: Ohm.Node, n$0: Ohm.Node, _2: Ohm.Node, t$0: Ohm.Node): any {
      const n = n$0.toAST(); ; const t = t$0.toAST()
      return (new (((Parameter).Typed))($meta(this), n, t))
    },
  ...
  newExpression(x: Ohm.Node): any {
    ...
    newExpression_alt1(this: Ohm.Node, _1: Ohm.Node, n$0: Ohm.Node, fs$0: Ohm.Node): any {
  ...
  recordExpression(x: Ohm.Node): any {
    ...
    recordExpression_alt2(this: Ohm.Node, _1: Ohm.Node, xs$0: Ohm.Node, _3: Ohm.Node): any {
      ; const xs = xs$0.toAST(); 
  ...
  recordField(x: Ohm.Node): any {
    ...
    recordField_alt3(this: Ohm.Node, _1: Ohm.Node, e$0: Ohm.Node, _3: Ohm.Node): any {
      ; const e = e$0.toAST(); 
  ...
  doc_line(x: Ohm.Node): any {
    ...
    doc_line_alt1(this: Ohm.Node, _1: Ohm.Node, _2: Ohm.Node, x$0: Ohm.Node, _4: Ohm.Node): any {
      ; ; const x = x$0.toAST(); 
      return x
    },
