...
type $p_Declaration<$T> = {
  ...
  Scene(pos: Meta, cmeta: Metadata, name: Name, body: Statement[]): $T;
...
export const toAstVisitor = {
  ...
  primaryExpression_alt2(this: Ohm.Node, x$0: Ohm.Node): any {
    const x = x$0.toAST();
