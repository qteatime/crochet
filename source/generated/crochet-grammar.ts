...
function $assert_type<T>(x: any, t: string, f: Typed): asserts x is T {
  ...
  Protect(pos: Meta, capability: Name, entity: ProtectEntity): $T;
      ...
      export abstract class Declaration extends Node {
        abstract tag: "ForeignType" | "Relation" | "Do" | "Command" | "Define" | "AbstractType" | "EnumType" | "SingletonType" | "Type" | "Trait" | "ImplementTrait" | "Action" | "When" | "Context" | "Open" | "Local" | "Test" | "Effect" | "Capability" | "Protect";
  ...
  Definition(pos: Meta, name: Name): $T;
      ...
      export abstract class ProtectEntity extends Node {
        abstract tag: "Type" | "Trait" | "Effect" | "Definition";
  ...
  NewNamed(pos: Meta, typ: Name, fields: Pair<RecordField, Expression>[]): $T;
  
  NewExtend(pos: Meta, typ: Name, base: Expression, fields: Pair<RecordField, Expression>[]): $T;
  ...
  Dsl(pos: Meta, language: TypeApp, ast: DslAst[]): $T;
      ...
      export abstract class Expression extends Node {
        abstract tag: "New" | "NewNamed" | "NewExtend" | "Invoke" | "Global" | "Variable" | "Self" | "List" | "Record" | "Search" | "MatchSearch" | "Project" | "Select" | "For" | "Block" | "Apply" | "Pipe" | "PipeInvoke" | "Interpolate" | "Condition" | "HasType" | "HasTrait" | "Force" | "Lazy" | "Hole" | "Return" | "Type" | "Lambda" | "IntrinsicEqual" | "ForeignInvoke" | "Parens" | "Lit" | "Handle" | "Perform" | "ContinueWith" | "Dsl";
  ...
  export class $$Expression$_NewNamed extends Expression {
    ...
    constructor(readonly pos: Meta, readonly typ: Name, readonly fields: Pair<RecordField, Expression>[]) {
      super();
      Object.defineProperty(this, "tag", { value: "NewNamed" });
      ($assert_type<Meta>(pos, "Meta", Meta)); ($assert_type<Name>(typ, "Name", Name)); ($assert_type<Pair<RecordField, Expression>[]>(fields, "Pair<RecordField, Expression>[]", $is_array(Pair)))
    }
  ...
  export class $$Expression$_NewExtend extends Expression {
    ...
    constructor(readonly pos: Meta, readonly typ: Name, readonly base: Expression, readonly fields: Pair<RecordField, Expression>[]) {
      super();
      Object.defineProperty(this, "tag", { value: "NewExtend" });
      ($assert_type<Meta>(pos, "Meta", Meta)); ($assert_type<Name>(typ, "Name", Name)); ($assert_type<Expression>(base, "Expression", Expression)); ($assert_type<Pair<RecordField, Expression>[]>(fields, "Pair<RecordField, Expression>[]", $is_array(Pair)))
    }
  ...
  dslNodeSeq(x: Ohm.Node): any {
    return x.toAST();
  },
  
    dslNodeSeq_alt1(this: Ohm.Node, xs$0: Ohm.Node): any {
      const xs = xs$0.toAST()
      return xs
    },
  ...
  dslNodeList(x: Ohm.Node): any {
    ...
    dslNodeList_alt1(this: Ohm.Node, _1: Ohm.Node, xs$0: Ohm.Node, _3: Ohm.Node): any {
      ; const xs = xs$0.toAST(); 
      return xs
    },
