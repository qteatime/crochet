...
export class $$PredicateExpression$_BinOp extends PredicateExpression {
  ...
  constructor(
    ...
    $assert_type<Meta>(pos, "Meta", Meta);
    $assert_type<BinOp>(op, "BinOp", BinOp);
    $assert_type<PredicateExpression>(
      left,
      "PredicateExpression",
      PredicateExpression
...
export abstract class BinOp extends Node {
  abstract tag:
    | "Add"
    | "Sub"
    | "Multiply"
    ...
    | "LessThan"
    | "LessOrEqual";
  abstract match<$T>(p: $p_BinOp<$T>): $T;
...
export class $$BinOp$_Add extends BinOp {
  readonly tag!: "Add";
...
export class $$BinOp$_Sub extends BinOp {
  readonly tag!: "Sub";
...
export class $$BinOp$_Multiply extends BinOp {
...
export class $$BinOp$_Equal extends BinOp {
  readonly tag!: "Equal";
...
export class $$BinOp$_NotEqual extends BinOp {
...
export class $$BinOp$_GreaterThan extends BinOp {
...
export class $$BinOp$_GreaterOrEqual extends BinOp {
  readonly tag!: "GreaterOrEqual";
...
export class $$BinOp$_LessThan extends BinOp {
...
export class $$BinOp$_LessOrEqual extends BinOp {
  readonly tag!: "LessOrEqual";
...
type $p_Constraint<$T> = {
  ...
  BinOp(pos: Meta, op: BinOp, left: Constraint, right: Constraint): $T;
...
export class $$Constraint$_BinOp extends Constraint {
  readonly tag!: "BinOp";
...
const toAstVisitor = {
  ...
  binOp(x: Ohm.Node): any {
    return x.toAST();
  },

  binOp_alt1(this: Ohm.Node, _1: Ohm.Node): any {
    return new BinOp.Add();
  },

  binOp_alt2(this: Ohm.Node, _1: Ohm.Node): any {
    return new BinOp.Sub();
  },

  binOp_alt3(this: Ohm.Node, _1: Ohm.Node): any {
    return new BinOp.Multiply();
  },

  binOp_alt4(this: Ohm.Node, _1: Ohm.Node): any {
    return new BinOp.Equal();
  },

  binOp_alt5(this: Ohm.Node, _1: Ohm.Node): any {
    return new BinOp.NotEqual();
  },

  binOp_alt6(this: Ohm.Node, _1: Ohm.Node): any {
    return new BinOp.GreaterThan();
  },

  binOp_alt7(this: Ohm.Node, _1: Ohm.Node): any {
    return new BinOp.GreaterOrEqual();
  },

  binOp_alt8(this: Ohm.Node, _1: Ohm.Node): any {
    return new BinOp.LessThan();
  },

  binOp_alt9(this: Ohm.Node, _1: Ohm.Node): any {
  ...
  eblock_alt1(this: Ohm.Node, s$0: Ohm.Node): any {
    const s = s$0.toAST();
    return s;
  },
