...
export abstract class Literal extends Node {
  abstract tag: "False" | "True" | "Text" | "Integer" | "Float";
...
const toAstVisitor = {
  ...
  contractDefinition_alt1(
    ...
    return new Contract($meta(this), pre, post);
  },
  ...
  primaryExpression_alt11(this: Ohm.Node, _1: Ohm.Node, t$0: Ohm.Node): any {
    const t = t$0.toAST();
    return new Expression.Type($meta(this), t);
  },

  primaryExpression_alt12(this: Ohm.Node, _1: Ohm.Node): any {
  ...
  primaryExpression_alt14(this: Ohm.Node, n$0: Ohm.Node): any {
    const n = n$0.toAST();
