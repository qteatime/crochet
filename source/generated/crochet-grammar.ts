...
export const toAstVisitor = {
  ...
  actionDeclaration_alt1(
    ...
    const b = b$0.toAST();
    const c = c$0.toAST();
    return new Declaration.Action($meta(this), m, t, n, p, r, b, c);
  },
