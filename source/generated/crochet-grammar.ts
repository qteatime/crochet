...
function $assert_type<T>(x: any, t: string, f: Typed): asserts x is T {
  ...
  Effect(pos: Meta, cmeta: Metadata, name: Name, cases: EffectCase[]): $T;
      ...
      export abstract class Declaration extends Node {
        abstract tag: "ForeignType" | "Relation" | "Do" | "Command" | "Define" | "AbstractType" | "EnumType" | "SingletonType" | "Type" | "Action" | "When" | "Context" | "Open" | "Local" | "Test" | "Effect";
  ...
  typeAppConstraint(x: Ohm.Node): any {
    return x.toAST();
  },
  
    typeAppConstraint_alt1(this: Ohm.Node, t$0: Ohm.Node, _2: Ohm.Node, c$0: Ohm.Node): any {
      const t = t$0.toAST(); ; const c = c$0.toAST()
      return c
    },
    
    typeAppConstraint_alt2(this: Ohm.Node, _1: Ohm.Node): any {
      return this.children[0].toAST();
    },
  ...
  typeAppPrimary(x: Ohm.Node): any {
    ...
    typeAppPrimary_alt2(this: Ohm.Node, n$0: Ohm.Node): any {
      const n = n$0.toAST()
      return (new (((TypeApp).Any))($meta(this)))
    },
    
    typeAppPrimary_alt3(this: Ohm.Node, _1: Ohm.Node, t$0: Ohm.Node, _3: Ohm.Node): any {
      ; const t = t$0.toAST(); 
      return t
    },
