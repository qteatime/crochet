...
function $assert_type<T>(x: any, t: string, f: Typed): asserts x is T {
  ...
  Handler(pos: Meta, name: Name, signature: (Signature<Parameter> | null), initialisation: Statement[], specs: HandlerSpec[]): $T;
  ...
  DefaultHandler(pos: Meta, name: Name): $T;
      ...
      export abstract class Declaration extends Node {
        abstract tag: "ForeignType" | "Relation" | "Do" | "Command" | "Define" | "AbstractType" | "EnumType" | "SingletonType" | "Type" | "Trait" | "ImplementTrait" | "Action" | "When" | "Context" | "Open" | "Local" | "Test" | "Effect" | "Capability" | "Protect" | "Decorated" | "Handler" | "DefaultHandler";
  ...
  export class $$Declaration$_Handler extends Declaration {
    ...
    constructor(readonly pos: Meta, readonly name: Name, readonly signature: (Signature<Parameter> | null), readonly initialisation: Statement[], readonly specs: HandlerSpec[]) {
      super();
      Object.defineProperty(this, "tag", { value: "Handler" });
      ($assert_type<Meta>(pos, "Meta", Meta)); ($assert_type<Name>(name, "Name", Name)); ($assert_type<(Signature<Parameter> | null)>(signature, "(Signature<Parameter> | null)", $is_maybe(Signature))); ($assert_type<Statement[]>(initialisation, "Statement[]", $is_array(Statement))); ($assert_type<HandlerSpec[]>(specs, "HandlerSpec[]", $is_array(HandlerSpec)))
    }

    match<$T>(p: $p_Declaration<$T>): $T {
      return p.Handler(this.pos, this.name, this.signature, this.initialisation, this.specs);
    }
  ...
  handlerDeclaration(x: Ohm.Node): any {
    ...
    handlerDeclaration_alt1(this: Ohm.Node, _1: Ohm.Node, n$0: Ohm.Node, s$0: Ohm.Node, b$0: Ohm.Node, _5: Ohm.Node, xs$0: Ohm.Node, _7: Ohm.Node): any {
      ; const n = n$0.toAST(); const s = s$0.toAST(); const b = b$0.toAST(); ; const xs = xs$0.toAST(); 
      return (new (((Declaration).Handler))($meta(this), n, s, b, xs))
    },
