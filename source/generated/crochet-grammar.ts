...
function $assert_type<T>(x: any, t: string, f: Typed): asserts x is T {
  ...
  Effect(pos: Meta, cmeta: Metadata, name: Name, cases: EffectCase[]): $T;
      ...
      export abstract class Declaration extends Node {
        abstract tag: "ForeignType" | "Relation" | "Do" | "Command" | "Define" | "AbstractType" | "EnumType" | "SingletonType" | "Type" | "Trait" | "ImplementTrait" | "Action" | "When" | "Context" | "Open" | "Local" | "Test" | "Effect";
  ...
  Dsl(pos: Meta, language: TypeApp, ast: DslAst[]): $T;
      ...
      export abstract class Expression extends Node {
        abstract tag: "New" | "Invoke" | "Global" | "Variable" | "Self" | "List" | "Record" | "Search" | "MatchSearch" | "Project" | "Select" | "For" | "Block" | "Apply" | "Pipe" | "PipeInvoke" | "Interpolate" | "Condition" | "HasType" | "HasTrait" | "Force" | "Lazy" | "Hole" | "Return" | "Type" | "Lambda" | "IntrinsicEqual" | "ForeignInvoke" | "Parens" | "Lit" | "Handle" | "Perform" | "ContinueWith" | "Dsl";
  ...
  Interpolation(pos: Meta, parts: Interpolation<DslAst>): $T;
  ...
  Dynamic(pos: Meta, value: Expression): $T;
      ...
      export abstract class DslAst extends Node {
        abstract tag: "Node" | "Lit" | "Var" | "List" | "Interpolation" | "Dynamic";
  ...
  export class $$DslAst$_Interpolation extends DslAst {
    readonly tag!: "Interpolation";

    constructor(readonly pos: Meta, readonly parts: Interpolation<DslAst>) {
      super();
      Object.defineProperty(this, "tag", { value: "Interpolation" });
      ($assert_type<Meta>(pos, "Meta", Meta)); ($assert_type<Interpolation<DslAst>>(parts, "Interpolation<DslAst>", Interpolation))
    }
  ...
  traitCommand(x: Ohm.Node): any {
    ...
    traitCommand_alt1(this: Ohm.Node, _1: Ohm.Node, _2: Ohm.Node): any {
      ; 
      return (() => { throw new Error(`Undefined rule traitCommand`) })()
    },
  ...
  traitImplementDeclaration(x: Ohm.Node): any {
    ...
    traitImplementDeclaration_alt1(this: Ohm.Node, _1: Ohm.Node, tr$0: Ohm.Node, _3: Ohm.Node, tp$0: Ohm.Node, _5: Ohm.Node): any {
      ...
      return (new (((Declaration).ImplementTrait))($meta(this), tr, tp))
    },
  ...
  typeConstraint(x: Ohm.Node): any {
    ...
    typeConstraint_alt2(this: Ohm.Node, t$0: Ohm.Node): any {
      const t = t$0.toAST()
  ...
  typeConstraint2(x: Ohm.Node): any {
    return x.toAST();
  },
  
    typeConstraint2_alt1(this: Ohm.Node, n$0: Ohm.Node): any {
      const n = n$0.toAST()
      return (new (((TypeConstraint).Type))($meta(this), (new (((TypeApp).Any))($meta(this)))))
    },
    
    typeConstraint2_alt2(this: Ohm.Node, t$0: Ohm.Node): any {
      const t = t$0.toAST()
      return (new (((TypeConstraint).Type))($meta(this), (new (((TypeApp).Named))($meta(this), t))))
    },
    
    typeConstraint2_alt3(this: Ohm.Node, _1: Ohm.Node, t$0: Ohm.Node, _3: Ohm.Node): any {
      ; const t = t$0.toAST(); 
      return t
    },
  ...
  typeApp(x: Ohm.Node): any {
    ...
    typeApp_alt1(this: Ohm.Node, t$0: Ohm.Node, _2: Ohm.Node, _3: Ohm.Node, _4: Ohm.Node): any {
      const t = t$0.toAST(); ; ; 
      return t
    },
  ...
  typeAppPrimary(x: Ohm.Node): any {
    ...
    typeAppPrimary_alt2(this: Ohm.Node, _1: Ohm.Node, t$0: Ohm.Node, _3: Ohm.Node): any {
      ; const t = t$0.toAST(); 
      return t
    },
  ...
  traitName(x: Ohm.Node): any {
    ...
    traitName_alt1(this: Ohm.Node, x$0: Ohm.Node): any {
      const x = x$0.toAST()
  ...
  one_handler(x: Ohm.Node): any {
    ...
    one_handler_alt1(this: Ohm.Node, _1: Ohm.Node, n$0: Ohm.Node, _3: Ohm.Node, v$0: Ohm.Node, _5: Ohm.Node, xs$0: Ohm.Node, _7: Ohm.Node, b$0: Ohm.Node): any {
  ...
  dslPrimary(x: Ohm.Node): any {
    ...
    dslPrimary_alt2(this: Ohm.Node, x$0: Ohm.Node): any {
      const x = x$0.toAST()
      return (new (((DslAst).Interpolation))($meta(this), x))
    },
    
    dslPrimary_alt3(this: Ohm.Node, l$0: Ohm.Node): any {
      const l = l$0.toAST()
      return (new (((DslAst).Lit))($meta(this), l))
    },
    
    dslPrimary_alt4(this: Ohm.Node, x$0: Ohm.Node): any {
      const x = x$0.toAST()
      return (new (((DslAst).Dynamic))($meta(this), x))
    },
    
    dslPrimary_alt5(this: Ohm.Node, xs$0: Ohm.Node): any {
      const xs = xs$0.toAST()
      return (new (((DslAst).List))($meta(this), xs))
    },
    
    dslPrimary_alt6(this: Ohm.Node, _1: Ohm.Node, x$0: Ohm.Node, _3: Ohm.Node): any {
      ; const x = x$0.toAST(); 
      return x
    },
